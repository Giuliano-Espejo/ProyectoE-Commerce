...
export default function Productos() {
  ...
  return (
    <div>
    <Carrusel />
      <h1 style={{ textAlign: "center",marginTop: "1rem", marginBottom: "1rem"}}>Productos</h1>
      <Row xs={1} md={2} lg={3} className="" style={{display:"inline-flex", marginLeft:"4rem", marginRight:"2rem"}}>
